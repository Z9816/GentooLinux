...
build_time_vars = {
    ...
    'BLDSHARED': 'x86_64-pc-linux-gnu-gcc -shared',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG',
    ...
    'CONFIGURE_CFLAGS': '',
    'CONFIGURE_CFLAGS_NODIST': '-O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden',
    'CONFIGURE_CPPFLAGS': '-I/usr/include/ncursesw',
    'CONFIGURE_LDFLAGS': '',
    'CONFIGURE_LDFLAGS_NODIST': '-Wl,-O1 -Wl,--as-needed -Wl,-z,pack-relative-relocs',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/usr' '--build=x86_64-pc-linux-gnu' '--host=x86_64-pc-linux-gnu' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--datadir=/usr/share' '--sysconfdir=/etc' '--localstatedir=/var/lib' '--datarootdir=/usr/share' '--docdir=/usr/share/doc/python-3.14.3' '--htmldir=/usr/share/doc/python-3.14.3/html' '--libdir=/usr/lib64' 'ac_cv_header_stropts_h=no' '--enable-shared' '--without-static-libpython' '--enable-ipv6' '--infodir=/usr/share/info' '--mandir=/usr/share/man' '--with-dbmliborder=gdbm' '--with-libc=' '--enable-loadable-sqlite-extensions' '--without-ensurepip' '--without-lto' '--with-system-expat' '--with-system-libmpdec' '--with-platlibdir=lib' '--with-pkg-config=yes' '--with-wheel-pkg-dir=/usr/lib/python/ensurepip' '--enable-gil' '--without-assertions' '--disable-experimental-jit' '--disable-optimizations' '--with-readline=readline' '--without-tail-call-interp' '--without-valgrind' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'PKG_CONFIG=x86_64-pc-linux-gnu-pkg-config' 'CFLAGS=' 'LDFLAGS=' 'CPPFLAGS= -I/usr/include/ncursesw'",
    'CONFINCLUDEDIR': '/usr/include',
    'CONFINCLUDEPY': '/usr/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3/lcov-report',
    ...
    'DESTDIRS': '/usr /usr/lib64 /usr/lib/python3.14 /usr/lib/python3.14/lib-dynload',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'x86_64-pc-linux-gnu-g++ -shared',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    ...
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBHACL_CFLAGS': '-I./Modules/_hacl -I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'MODDISABLED_NAMES': 'nis  _tkinter',
    'MODLIBS': '-lm',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/usr/lib64/libffi/include',
    ...
    'MODULE__CTYPES_TEST_CFLAGS': '-I/usr/lib64/libffi/include',
    ...
    'MODULE__CURSES_CFLAGS': '-D_DEFAULT_SOURCE  -I/usr/include/ncursesw',
    'MODULE__CURSES_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_LDFLAGS': '-lncursesw -ltinfow',
    'MODULE__CURSES_PANEL_CFLAGS': '-I/usr/include/ncursesw -D_DEFAULT_SOURCE  -D_DEFAULT_SOURCE  -I/usr/include/ncursesw',
    'MODULE__CURSES_PANEL_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_PANEL_LDFLAGS': '-lpanelw -lncursesw -ltinfow',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG',
    'PY_CFLAGS_NODIST': '-O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-Wl,-O1 -Wl,--as-needed -Wl,-z,pack-relative-relocs',
    'PY_CPPFLAGS': '-I. -I./Include -I/usr/include/ncursesw',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 1,
    'PY_LDFLAGS': '',
    'PY_LDFLAGS_NODIST': '-Wl,-O1 -Wl,--as-needed -Wl,-z,pack-relative-relocs',
    'PY_LDFLAGS_NOLTO': '',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 1,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -O2 -pipe -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/usr/include/ncursesw -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3',
    'SCRIPTDIR': '/usr/lib',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3 ./python -E -m test',
    ...
    'abs_builddir': '/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3',
    'abs_srcdir': '/var/tmp/portage/dev-lang/python-3.14.3/work/Python-3.14.3',
